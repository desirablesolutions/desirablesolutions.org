...
var useHover = function (props) {
    ...
    var springProps = Object.entries(props).reduce(function (acc, entry) {
        var _a;
        var key = entry[0];
        var value = entry[1];
        if (key === 'animationConfig') {
            if (typeof value === 'string') {
                return __assign(__assign({}, acc), { config: reactSpring.config[value] });
            }
            if (typeof value === 'object') {
                return __assign(__assign({}, acc), { config: value });
            }
        }
    ...
    var spring = reactSpring.useSpring(springProps);
    return {
        spring: spring,
...
var AnimationWrapper = function (_a) {
    var children = _a.children, config = _a.config, style = _a.style, reset = _a.reset, animationConfig = _a.animationConfig, rest = __rest(_a, ["children", "config", "style", "reset", "animationConfig"]);
    var passedConfig = __assign(__assign({}, config), { animationConfig: typeof animationConfig === 'string'
            ? animationConfig
            : __assign({}, animationConfig) });
